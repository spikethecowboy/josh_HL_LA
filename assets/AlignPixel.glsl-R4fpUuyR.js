import{D as e,E as t,O as n,T as r,j as i}from"./TriangleTechniqueConfiguration-Dj5WAscc.js";import{a,d as o,f as s}from"./SceneLighting-De6mXDNP.js";import{f as c,l}from"./oitResolution.glsl-BVWSicBI.js";import{a as u,t as d}from"./BooleanBindUniform-DLlcYQLS.js";var f=.5;function p(d,f){let p=d.vertex;d.include(s),d.attributes.add(`position`,`vec3`),d.vertex.inputs.add(`position`,()=>`position`),d.attributes.add(`normal`,`vec3`),f.hasVertexCenterOffset?d.attributes.add(`centerOffset`,`vec3`):p.constants.add(`centerOffset`,`vec3`,[0,0,0]),d.attributes.add(`groundDistance`,`float`),t(p,f),r(p,f),p.uniforms.add(new a(`viewport`,e=>e.camera.fullViewport),new l(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&u(p),p.code.add(c`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
