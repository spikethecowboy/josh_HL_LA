import{M as e,o as t}from"./promiseUtils-BDZh0__L.js";import{E as n}from"./vec2-CRDTdDt5.js";import{l as r}from"./screenUtils-BgtSGq1D.js";import{l as i}from"./vec4-B-G2J025.js";import{a}from"./vec4f64-CpfEPfj5.js";import{$ as o}from"./index-KvdQrKJF.js";import{C as s,Et as c,L as l,T as u}from"./TriangleTechniqueConfiguration-DKMfjFxI.js";import{a as d,d as f,f as p}from"./SceneLighting-JLGpf60F.js";import{f as m,u as h}from"./oitResolution.glsl-DcSp5qwA.js";import{t as g}from"./NoParameters-ZDc3QXO4.js";function _(e){e.uniforms.add(new s(`zProjectionMap`,e=>v(e.camera))),e.code.add(m`float linearizeDepth(float depth, vec2 zProjectionConstants) {
...
}`)}function v(e){let t=e.projectionMatrix;return n(y,t[14],t[10])}var y=o();function b(e){e.fragment.uniforms.add(new d(`projInfo`,e=>x(e.camera))),e.fragment.uniforms.add(new s(`zScale`,e=>C(e.camera))),e.fragment.code.add(m`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function x(e){let t=e.projectionMatrix;return t[11]===0?i(S,2/(e.fullWidth*t[0]),2/(e.fullHeight*t[5]),(1+t[12])/t[0],(1+t[13])/t[5]):i(S,-2/(e.fullWidth*t[0]),-2/(e.fullHeight*t[5]),(1-t[8])/t[0],(1-t[9])/t[5])}var S=a();function C(e){return e.projectionMatrix[11]===0?n(w,0,1):n(w,1,0)}var w=o(),T=class extends h{constructor(e,t,n){super(e,`mat4`,1,(r,i,a)=>r.setUniformMatrix4fv(e,t(i,a),n))}},E=class{constructor(e){this.screenLength=r(e.screenLength),this.minWorldLength=e.minWorldLength??0,this.maxWorldLength=e.maxWorldLength??1/0}};function D(e,t){let n=e.vertex;t.hasVerticalOffset?(k(n),t.hasScreenSizePerspective&&(e.include(p),f(n),u(e.vertex,t)),n.code.add(m`
