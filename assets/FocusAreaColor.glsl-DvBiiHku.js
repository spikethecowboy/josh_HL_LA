import{t as e}from"./signal-rCBW0pSP.js";import{g as t,h as n}from"./SceneLighting-JLGpf60F.js";import{c as r,f as i,l as a}from"./oitResolution.glsl-DcSp5qwA.js";import{t as o}from"./NoParameters-ZDc3QXO4.js";import{t as s}from"./ShaderBuilder-DQUqAgV6.js";var c=class extends o{constructor(){super(...arguments),this.effect=0,this.fadeFactor=e(1)}};function l(){let e=new s;return e.include(n),e.outputs.add(`fragColor`,`vec4`,0),e.fragment.uniforms.add(new r(`colorTexture`,e=>e.color),new r(`focusArea`,e=>e.focusArea),new t(`focusAreaEffectMode`,e=>e.effect),new a(`fadeFactor`,e=>e.fadeFactor.value)).main.add(i`
